...
class User(AbstractBaseUser):
    ...
    # staff permissions
    station_name = models.ForeignKey('ticket.Substations', on_delete=models.DO_NOTHING, blank=True, null=True)
    company = models.ForeignKey('company.Company', on_delete=models.DO_NOTHING, blank=True, null=True)
